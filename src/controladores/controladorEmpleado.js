...
exports.inicio = (req, res)=>{
    var info = {
        rutas:[
            {
                descripcion: 'Informacion general de las rutas de empleado',
                metodo: 'get',
                url: 'servidor:3001/api/empleado/',
                parametros: 'ninguno'   
            },
            {
                descripcion: 'Lista todos los empleados',
                metodo: 'get',
                url: 'servidor:3001/api/empleado/listar',
                parametros: 'ninguno'   
            },
        ]
    }
...
exports.eliminar = async (req, res) => {
    ...
    if(ers.length>0){
        ...
        try {
            const { id_empleado } = req.query;
            await modeloEmpleado.destroy({ where: { id_empleado: id_empleado}})
            .then((data)=>{
                res.statusCode = 200;
                res.setHeader("Content-Type", "application/json");
